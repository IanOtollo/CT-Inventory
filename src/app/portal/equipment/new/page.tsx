...
export default function NewEquipmentPage() {
  ...
  const handleQuickAddEmployee = async (e: React.FormEvent) => {
    ...
    // In a real app, call convex mutation to create employee in this department
    alert("Employee created! (Mocked)");
  ...
  // Mock categories (would use query in real app)
  const categories = [
    { _id: "1", name: "Laptop" },
      ...
      <div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Add a new physical asset to your department's inventory.</p>
          </div>
        </div>
      </div>
