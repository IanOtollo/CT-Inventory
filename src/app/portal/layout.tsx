...
export default function PortalLayout({
  ...
  const updateCredentials = useMutation(api.auth.updateCredentials);
  ...
  const navLinks = [
    { name: "Dash", href: "/portal", icon: LayoutDashboard },
    { name: "Staff", href: "/portal/employees", icon: Users },
    { name: "Assets", href: "/portal/equipment", icon: Monitor },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Top Header */}
      <header className="bg-white border-b border-gray-200 h-16 flex items-center px-4 sm:px-6 shadow-sm sticky top-0 z-10">
        ...
        <div className="ml-auto flex items-center space-x-4">
          <button 
            ...
            className="flex items-center text-gray-500 hover:text-[var(--color-busia-blue)] transition-colors" 
            title="Settings"
          >
            <Settings size={20} />
          </button>
      ...
      {isSettingsOpen && (
        <div className="fixed inset-0 z-[100] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="relative z-10 inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border-t-4 border-t-[var(--color-busia-blue)]">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form onSubmit={handleSettingsSubmit} className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Update Email Address (Optional)</label>
                    <input
                      type="email"
                      value={newEmail}
                  ...
                  <div className="pt-4 flex justify-end space-x-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[var(--color-busia-blue)] hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-busia-blue)] disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center min-w-[100px]"
                    >
